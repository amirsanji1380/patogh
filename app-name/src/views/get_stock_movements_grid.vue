      ...
      <div class="dx-card responsive-paddings">
            ...
            <div class="dx-fieldset">
              <div class="dx-field">
                <DxButton
                  ...
                  @click="get_stock_movements_grid($event)"
                />
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          >
            ...
            <dx-column data-field="qty" caption="تعداد" />
            <dx-column data-field="reference" caption="کد رهگیری" />
            <dx-column data-field="cost" caption="ارزش ریالی(تعداد * قیمت)" />
            <dx-column data-field="location_name" caption="نام انبار" />
            <dx-column data-field="standard_cost" caption="قیمت" />
            <dx-column data-field="sum_diff" caption="قیمت تمام شده" />
            <dx-column data-field="time2" caption="زمان ثبت" />
          </dx-data-grid>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    get_stock_movements_grid() {
      let _self = this;
      axios
        .get(
          `http://ketabtem.ir/patogh/book_server/php/get_stock_movements.php?fromDate=${_self.jalaliFromDate}&toDate=${_self.jalaliToDate}&loc_code=${_self.location}`
        )
